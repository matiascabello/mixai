...
// Middleware redirects unauthenticated requests to "/" before this page ever renders,
// so no client-side session check is needed here — reaching this component means we're logged in.
export default function Home() {
  ...
  const currentStep = !personaId ? 2 : playlistId ? 5 : proposal ? 4 : 3;
  ...
  return (
    <main className="page">
      <div className="top-bar">
        ...
        <AccountBadge onLoggedOut={handleLoggedOut} />
      </div>
      <StepIndicator currentStep={currentStep} />

      {!personaId && <PersonaPicker onSelect={setPersonaId} />}

      {personaId && !playlistId && (
